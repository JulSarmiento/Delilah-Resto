...
const orderValidator = require('../middlewares/order-body-validator')
...
// Orders router
router.route('/orders')
    .get([isLoggedIn], OrderController.listOrders)
    .post([isLoggedIn, isAdmin, orderValidator], OrderController.createOrder)
